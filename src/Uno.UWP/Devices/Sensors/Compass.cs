...
public partial class Compass
{
	...
	private readonly StartStopEventWrapper<TypedEventHandler<Compass, CompassReadingChangedEventArgs>> _readingChangedWrapper;
	...
	private Compass()
	{
		_readingChangedWrapper = new StartStopEventWrapper<TypedEventHandler<Compass, CompassReadingChangedEventArgs>>(
			() => StartReadingChanged(),
			() => StopReadingChanged(),
			_syncLock);
	}
	...
	{
		_readingChangedWrapper.Event?.Invoke(this, new CompassReadingChangedEventArgs(reading));
	}
}
#endif
