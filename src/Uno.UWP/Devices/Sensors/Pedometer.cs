...
namespace Windows.Devices.Sensors
{
	...
	public partial class Pedometer
	{
		...
		private readonly StartStopEventWrapper<TypedEventHandler<Pedometer, PedometerReadingChangedEventArgs>> _readingChangedWrapper;
		...
		private Pedometer()
		{
			_readingChangedWrapper = new StartStopEventWrapper<TypedEventHandler<Pedometer, PedometerReadingChangedEventArgs>>(
				() => StartReading(),
				() => StopReading(),
				_syncLock);
		}
