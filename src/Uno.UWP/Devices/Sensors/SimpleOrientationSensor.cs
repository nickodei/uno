...
namespace Windows.Devices.Sensors
{
	...
	{
		private readonly StartStopEventWrapper<TypedEventHandler<SimpleOrientationSensor, SimpleOrientationSensorOrientationChangedEventArgs>> _orientationChangedWrapper;
...
#pragma warning restore CS0649 // Field 'SimpleOrientationSensor._currentOrientation' is never assigned to, and will always have its default value
		...
		{
			_orientationChangedWrapper = new StartStopEventWrapper<TypedEventHandler<SimpleOrientationSensor, SimpleOrientationSensorOrientationChangedEventArgs>>(
...
#pragma warning restore CS0067 // The event 'SimpleOrientationSensor.OrientationChanged' is never used
		...
		private void SetCurrentOrientation(SimpleOrientation orientation)
		{
			if (_currentOrientation != orientation)
			{
				...
				_orientationChangedWrapper.Event?.Invoke(this, args);
			}
		}
